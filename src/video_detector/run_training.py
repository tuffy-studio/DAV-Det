...
def main():
    ...
    parser.add_argument('--checkpoint_root', default='checkpoints', type=str, help='root directory to save checkpoints')
    ...
    # 构造数据集
    train_dataset = FineTuneDataset(args.data_train, data_augment=True, mean=mean, std=std, if_normalize=True, img_size=512)
    ...
    # 构造模型并加载预训练权重
    ft_model = GPS_DINO(backbone_name="./dinov3-vitl16-pretrain-lvd1689m/", use_lora=True, lora_r=32, lora_alpha=16)
